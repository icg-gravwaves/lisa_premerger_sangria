...
Sangria-HM in Section~\ref{sec:zerolag_sangria}, showing the potential pitfalls of na\"ive implementation
of the search.

These pitfalls lead us to consider utilising the inpainting technique of~\cite{Zackay:2019kkv} as an
alternative to the zero-lag filter of~\cite{CabournDavies:2024hea}. This is described in
