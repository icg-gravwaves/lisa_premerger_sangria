...
alternative to the zero-latency filter of~\cite{CabournDavies:2024hea}. Inpainting has been used in
the context of addressing gaps in LISA data in \cite{Blelly:2021oim}, but here we apply it to a `gap'
