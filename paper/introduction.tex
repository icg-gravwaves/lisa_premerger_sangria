...
MockLISADataChallengeTaskForce:2009wir, LDC_WEBSITE}. Because these signals will
...
electromagnetic facilities to be pointed at the source region rapidly to maximise observation.
...
Sangria-HM in Section~\ref{sec:fir_sangria}, showing the potential pitfalls of na\"ive implementation
of the search. We then discuss utilising the inpainting technique as an alternative to the one-sided
\ac{FIR} filter in Section~\ref{sec:inpainting}, and apply it in Section~\ref{sec:inpainting_sangria}
