...
% Easily toggle formatting for the resubmitted manuscript
% Formatting ON
\newcommand{\updated}[1]{\textbf{#1}}
...
\title{Inpainting to search for premerger massive black hole binaries in realistic LISA datasets.}
...
\begin{abstract}
    ...
    simultaneously in gravitational waves and with electromagnetic observatories.
    ...
    We demonstrate that the inpainting method can identify premerger signals even when gaps are present in the data,
    demonstrating the recovery of a signal even when three day-long data gaps are added to the 14 days preceding merger.
...
% Gareth I'm removing most of the acronym definitions. Write these things out in full.
% Do NOT add any back here. I'm keeping LISA and MBHB, but nothign else.
...
GCD and IH acknowledge support from the UKSA, through grant UKRI968,
...
\texttt{lisabeta} \cite{Marsat:2020rtl},
