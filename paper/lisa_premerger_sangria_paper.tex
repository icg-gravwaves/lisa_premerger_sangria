...
\title{Applying gloss with inpainting: pre-merger searches for massive black hole binaries in realistic LISA datasets}
...
\begin{abstract}
    ...
    Interferometer Space Antena (LISA) will provide the best chance to
    maximise the science of LISA and its electromagnetic followups. By
    ...
    search is based on a Finite Impulse Response (FIR) filter which does not
