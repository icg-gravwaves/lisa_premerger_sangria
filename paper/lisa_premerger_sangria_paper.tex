...
\begin{abstract}
    ...
    We show that the inpainting method can identify premerger signals even when gaps are present in the data, demonstrating the recovery of signal 0 even when 3 day-long data gaps are added to the 14 days preceding merger.
